					...
					<div class="col">
						<div class="card">
					        <div class="card-body">
					        	<div class="row">
					        		<div class="col">
					        			<div class="page-title">Academic Rank</div>
					        		</div>
					        		<div class="col">
					        			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
											<button class="btn btn-primary" onclick="window.location.href='add.php';" type="button">Add Academic Rank</button>	
							            </div>
					        		</div>
						        </div>
					        </div>
							...
							<table class="table table-hover table-bordered align-middle">
								...
								<tbody>
									<?php foreach($display_ranks as $rank) { ?>
										<tr>
											<td height="50px"><?php echo $rank['id']; ?></td>
											<td height="50px"><?php echo $rank['description']; ?></td>
											<td><a class="action-button edit" href="edit.php?id=<?php echo $rank['id']; ?>">Edit</a></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
