<?php
	...
	if(isset($_GET['id']) && !empty($_GET['id'])) {
		$editId = $_GET['id'];
		$rank = AcademicRank::find_by_id($editId);
	}
	if(isset($_POST['submit'])) {
		AcademicRank::edit_academicrank_data($_POST);
	} 
?> 
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="content">
			<div class="container">
					...
					<div class="col">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col">
										<a class="clickable-page-title" href="rank.php">Academic Rank</a>
										<div class="page-title"> &nbsp;- Edit Academic Rank</div>
									</div>
									<div class="col">
				...
				<div class="card">
					<div class="card-body">
						<form action="edit.php?id=<?php echo $rank[0]['id']; ?>" method="POST">
							<div class="row">
								<div class="col">
									<div class="form-floating mb-3">
										<input type="text" name="description" class="form-control" id="floatingInput" value="<?php echo $rank[0]['description']; ?>">
										<label for="floatingInput">Description</label>
									</div>
									<div class="d-grid gap-2 d-md-flex justify-content-md-end">
										<input type="submit" name="submit" value="Save Academic Rank Data">
									</div>
								</div>
							</div>
						</form>
