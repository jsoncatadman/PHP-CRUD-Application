<?php
	...
	$department = Department::find_by_id($faculty[0]['departmentID']);

	if(isset($_GET['id']) && !empty($_GET['id'])) {
		$editId = $_GET['id'];
		$faculty = Faculty::find_by_id($editId);
	}
	if(isset($_POST['submit'])) {
		Faculty::edit_faculty_data($_POST);
	}
?> 
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="content">
			<div class="container">
							...
							<div class="card-body">
								<div class="row">
									<div class="col">
										...
										<div class="page-title"> &nbsp;- Modify Faculty Data</div>
									</div>
									<div class="col">
				...
				<div class="card">
					<div class="card-body">
						<form action="edit.php?id=<?php echo $faculty[0]['id']; ?>" method="POST">
							<div class="row">
								<div class="col-md-6">
									<div class="form-floating mb-3">
										<input type="number" name="emp_no" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['emp_no']; ?>">
											...
											<option selected>Academic Rank</option>
												<?php
													foreach($display_ranks as $rank) {
														if($rank['id'] == $faculty[0]['academic_rankID']) {
															echo '<option selected="selected" value="'.$rank['id'].'">'.$rank['description'].'</option>';
														}
														else {
									...
									<div class="form-floating mb-3">
										<input type="text" name="first_name" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['first_name']; ?>">
										<label for="floatingInput">Firstname</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" name="last_name" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['last_name']; ?>">
										<label for="floatingInput">Lastname</label>
									</div>
									<div class="form-floating mb-3">
										<input type="tel" name="mobile_number" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['mobile_number']; ?>">
										<label for="floatingInput">Mobile Number</label>
									</div>
									<div class="form-floating mb-3">
										<input type="email" name="email_address" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['email_address']; ?>">
								...
								<div class="col-md-6">
											...
											<option selected>College</option>
												<?php
													foreach($display_colleges as $college) {
														if($college['id'] == $faculty[0]['collegeID']) {
									...
									<div class="mb-4">
										...
										<option selected="selected" value=" <?php echo $department[0]['id']; ?>" > <?php echo $department[0]['description'] ?> </option>';

										</select>
									</div>
									<div class="form-floating mb-3">
										<input type="text" name="undergrad_course" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['undergrad_course']; ?>">
										<label for="floatingInput">Undergraduate Course</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" name="masters_degree" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['masters_degree']; ?>">
										<label for="floatingInput">Master's Degree</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" name="doctorate_degree" class="form-control" id="floatingInput" value="<?php echo $faculty[0]['doctorate_degree']; ?>">
