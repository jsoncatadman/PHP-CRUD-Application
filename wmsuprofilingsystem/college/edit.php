<?php
	...
	if(isset($_POST['submit'])) {
		College::edit_college_data($_POST);
	} 
?> 
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="content">
			<div class="container">
							...
							<div class="card-body">
								<div class="row">
									<div class="col">
										...
										<div class="page-title"> &nbsp;- Edit College</div>
									</div>
									<div class="col">
				...
				<div class="card">
					<div class="card-body">
						<form action="edit.php?id=<?php echo $college[0]['id']; ?>" method="POST">
							<div class="row">
								<div class="col">
									<div class="form-floating mb-3">
										<input type="text" name="code" class="form-control" id="floatingInput" value="<?php echo $college[0]['code']; ?>">
										<label for="floatingInput">Code</label>
									</div>
									<div class="form-floating mb-3">
										<input type="text" name="description" class="form-control" id="floatingInput" value="<?php echo $college[0]['description']; ?>">
										<label for="floatingInput">Description</label>
									</div>
									<div class="d-grid gap-2 d-md-flex justify-content-md-end">
										<input type="submit" name="submit" value="Save College Data">
									</div>
								</div>
							</div>
						</form>
