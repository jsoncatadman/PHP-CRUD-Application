					...
					<div class="col">
						<div class="card">
					        <div class="card-body">
					        	<div class="row">
					        		<div class="col">
					        			<div class="page-title">College</div>
					        		</div>
					        		<div class="col">
					        			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
											<button class="btn btn-primary" onclick="window.location.href='add.php';" type="button">Add College</button>	
							            </div>
					        		</div>
						        </div>
					        </div>
				...
				<div class="card">
					<div class="card-body">
						<div class="row m-1 mt-3">
				            <div class="table-responsive adjust p-2"> 
				                <table id="datatable" class="table table-sm table-hover table-bordered align-middle">
				                    <thead>
										<tr bgcolor="#395a72" height="40px" class="align-middle">
											<th>ID</th>
											<th>Code</th>
											<th>Description</th>
											<th>Edit</th>
		...
		<div class="content">
			<div class="container">
				...
				<div class="card">
					<div class="card-body">
						<div class="row">
				            <div class="table-responsive adjust"> 
				                <table id="datatable" class="table table-sm table-hover table-bordered align-middle">
				                    <thead>
